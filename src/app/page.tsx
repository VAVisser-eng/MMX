...
const cars = inventory as InventoryCar[];
      ...
      <section className="border-b border-white/10 bg-[radial-gradient(circle_at_70%_10%,rgba(255,111,0,0.20),transparent_32%),linear-gradient(135deg,#000_0%,#080808_52%,#160b02_100%)]">
        ...
        <div className="mx-auto max-w-7xl px-5 pb-20 pt-16 sm:px-8 lg:px-10">
          ...
          <p className="mt-7 max-w-2xl text-lg leading-8 text-zinc-300 sm:text-xl">
            De voorraad komt uit een lokale kopie van de MMX sheet. Kies type,
        ...
        <div className="mx-auto max-w-7xl">
          <div className="mb-8 flex flex-col justify-between gap-5 md:flex-row md:items-end">
            ...
            <p className="max-w-xl text-zinc-400">
              Bronbestand: <span className="text-white">MMX inventory.xlsx</span>.
              Later kunnen we dit automatisch laten verversen vanuit de online sheet.
            </p>
          </div>
